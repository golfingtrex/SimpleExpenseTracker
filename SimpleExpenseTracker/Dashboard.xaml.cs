...
namespace SimpleExpenseTracker
{
    ...
    public partial class Dashboard : UserControl
    {
        ...
        public Dashboard()
        {
            ...
            DataContext = this;
            string imgCartoon = $"{Directory.GetParent(Directory.GetCurrentDirectory())?.Parent?.Parent}\\Images\\Lady.png";
            string imgAvatar = $"{Directory.GetParent(Directory.GetCurrentDirectory())?.Parent?.Parent}\\Images\\ScienceMan.png";
